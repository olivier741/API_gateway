...
public class WS_Billing_Hist implements Serializable {
    ...
    private WS_Type_Charging type_changing;
    
    @Enumerated(EnumType.STRING)
    private WS_Type_Account type_account;
    ...
    public WS_Type_Charging getType_changing() {
        return type_changing;
    }

    public WS_Type_Account getType_account() {
        return type_account;
    }
    ...
    public void setType_changing(WS_Type_Charging type_changing) {
        this.type_changing = type_changing;
    }

    public void setType_account(WS_Type_Account type_account) {
